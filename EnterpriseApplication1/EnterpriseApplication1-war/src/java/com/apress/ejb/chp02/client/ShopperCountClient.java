...
public class ShopperCountClient extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ShopperCountClient at " + request.getContextPath() + "</h1>");
            out.println("<h1>Testing Shopper Count Bean client</h1>");
            out.println("<h1>Incrementing shopper count:</h1>");
            for(int i = 0; i< 10; i++ ){
                shopperCount.incrementShopperCount();
            }
            out.println("<h1>Displaying shopper count:</h1>");
            out.println("<p>" + shopperCount.getNumberOfShopers() + "</p>");
            out.println("</body>");
            out.println("</html>");
        }
    }
