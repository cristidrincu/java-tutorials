...
import com.apress.ejb.chp02.ShoppingCartBean;
...
public class ShoppingCartClient extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Testing Shoping Cart Client...  </h1>");
            out.println("<p>Adding wine item</p>");            
            out.println("<h3>Displaying items in the cart</h3>");
            ArrayList<String> cartItems = shoppingCart.getCartItems();
            for(String item : cartItems){
                out.println("<ul><li>" + item + "</li></ul>");
            }
            out.println("</body>");
            out.println("</html>");
        }
